...
print auth_url
print ''
print 'After accepting the grant, enter the authorization code from the'
print '"code" parameter in the URL to which you are redirected.'
print ''
...
print ''
print 'API request succeeded! Returned the following content:'
